    ...
    public void submitButtonAction() {
        if (areToateCampurileCompletate()) {
            ...
            if (firstNameText.getText().isEmpty()) {
                ...
                firstNameText.setStyle("-fx-border-color: none; -fx-border-width: none ;");
            if (lastNameText.getText().isEmpty()) {
                lastNameText.setStyle("-fx-border-color: red; -fx-border-width: 2px ;");
            }
            else
                lastNameText.setStyle("-fx-border-color: none; -fx-border-width: none ;");
            if (phoneNumber.getText().isEmpty()) {
                phoneNumber.setStyle("-fx-border-color: red; -fx-border-width: 2px ;");
            }
            else
                phoneNumber.setStyle("-fx-border-color: none; -fx-border-width: none ;");
            if (dateOfBirth.getValue() == null) {
                dateOfBirth.setStyle("-fx-border-color: red; -fx-border-width: 2px ;");
            }
            else
                dateOfBirth.setStyle("-fx-border-color: none; -fx-border-width: none ;");
